...
PVector scalarProjection(PVector p, PVector a, PVector b) {
  ...
  //Calculate scalar projection itself
  ab.mult(ap.dot(ab));
  PVector normalPoint = PVector.add(a, ab);
  return normalPoint;
}

//PVector scalarProjection2(PVector p, PVector a, PVector b) {
//  PVector ap = PVector.sub(p, a);
//  PVector ab = PVector.sub(b, a);
//  //float aMag = a.mag();
//  float theta = PVector.angleBetween(ap, ab);
  
//  PVector SPpoint = ap.mult(cos(theta));
//  PVector normalPoint2 = PVector.add(a, SPpoint);
//  return normalPoint2;
//}
